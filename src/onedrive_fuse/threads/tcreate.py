...
from onedrive_fuse import common, commonfunc, metrics, metadata, lock
from onedrive_fuse.log import logger
from onedrive_fuse.remote import create, symlink, attr
from onedrive_fuse.threads import tupload
                    ...
                    try:
                        ...
                        for timeout in commonfunc.apiTimeoutRange():
                            try:                            
                                ...
                                if d == None:
                                    logger.warning(f'create: {path} noop already deleted local_id={localId}')
                                    break
