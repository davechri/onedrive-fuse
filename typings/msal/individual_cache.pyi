...
class _ExpiringMapping(MutableMapping):
    _INDEX = ...
    def __init__(self, mapping=..., capacity=..., expires_in=..., lock=..., *args, **kwargs) -> None:
...
class _IndividualCache:
    def __init__(self, mapping=..., key_maker=..., expires_in=...) -> None:
    ...
    def __call__(self, function): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
        ...
