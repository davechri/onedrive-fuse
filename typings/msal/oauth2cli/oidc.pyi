...
logger = ...
def decode_part(raw, encoding=...): # -> str | bytes:
...
def decode_id_token(id_token, client_id=..., issuer=..., nonce=..., now=...): # -> Any:
...
class Client(oauth2.Client):
    ...
    """
    def decode_id_token(self, id_token, nonce=...): # -> Any:
        """See :func:`~decode_id_token`."""
        ...
    
    def build_auth_request_uri(self, response_type, nonce=..., **kwargs): # -> str:
    ...
    def obtain_token_by_authorization_code(self, code, nonce=..., **kwargs): # -> Any:
    ...
    def initiate_auth_code_flow(self, scope=..., **kwargs): # -> dict[str, Any]:
    ...
    def obtain_token_by_browser(self, display=..., prompt=..., max_age=..., ui_locales=..., id_token_hint=..., login_hint=..., acr_values=..., **kwargs): # -> Any | dict[str, Any]:
