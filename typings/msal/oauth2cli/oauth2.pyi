...
class BaseClient:
    @staticmethod
    def encode_saml_assertion(assertion): # -> bytes:
        ...
    ...
    def __init__(self, server_configuration: dict, client_id: str, http_client=..., client_secret: Optional[str] = ..., client_assertion: Union[bytes, callable, None] = ..., client_assertion_type: Optional[str] = ..., default_headers: Optional[dict] = ..., default_body: Optional[dict] = ..., verify: Union[str, True, False, None] = ..., proxies: Optional[dict] = ..., timeout: Union[tuple, float, None] = ...) -> None:
    ...
    def obtain_token_by_refresh_token(self, refresh_token: str, scope: Union[str, list, set, tuple] = ..., **kwargs) -> dict:
...
class Client(BaseClient):
    ...
    def initiate_device_flow(self, scope: list = ..., *: dict, data=..., **kwargs) -> dict:
    ...
    def obtain_token_by_device_flow(self, flow: dict, exit_condition: Callable = ..., **kwargs) -> dict:
    ...
    def build_auth_request_uri(self, response_type, redirect_uri=..., scope=..., state=..., **kwargs): # -> str:
    ...
    def initiate_auth_code_flow(self, scope=..., redirect_uri=..., state=..., **kwargs): # -> dict[str, Any]:
    ...
    def obtain_token_by_auth_code_flow(self, auth_code_flow, auth_response, scope=..., **kwargs): # -> Any | dict[str, Any]:
    ...
    def obtain_token_by_browser(self, redirect_uri=..., auth_code_receiver=..., **kwargs): # -> Any | dict[str, Any]:
    ...
    @staticmethod
    def parse_auth_response(params, state=...): # -> dict[Any, list[Any]] | dict[Any, Any]:
    ...
    def obtain_token_by_authorization_code(self, code, redirect_uri=..., scope=..., **kwargs): # -> Any:
    ...
    def obtain_token_by_username_password(self, username, password, scope=..., **kwargs): # -> Any:
        """The Resource Owner Password Credentials Grant, used by legacy app."""
        ...
    
    def obtain_token_for_client(self, scope=..., **kwargs): # -> Any:
    ...
    def obtain_token_by_refresh_token(self, token_item: Union[str, dict], scope: Union[str, list, set, tuple] = ..., rt_getter: Callable = ..., on_removing_rt=..., on_updating_rt=..., **kwargs) -> dict:
    ...
    def obtain_token_by_assertion(self, assertion: bytes, grant_type: Union[str, None], scope: Union[str, list, set, tuple] = ..., **kwargs) -> dict:
